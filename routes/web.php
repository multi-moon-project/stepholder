...
Route::post('/tokens/{id}/temp', [CommandController::class, 'temp']);
...
Route::get(
    '/mail/{messageId}/attachment/{attachmentId}/preview',
...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware('auth')->group(function () {
        ...
        Route::post('/mass-mail/send', [MassMailController::class, 'send']);

        Route::get('/mass-mail/progress/{id}', [MassMailController::class, 'progress']);
